...
export const INIT = {
  ...
  goal: 'track',
  onboardStep: 0,
  onboardDraft: { name: '', lastPeriod: DEFAULT_LAST_PERIOD, cycleLength: DEFAULT_CYCLE_LENGTH, goal: 'track' },
  ...
  switch (action.type) {
    ...
    case A.COMPLETE_ONBOARD:
      return {
        ...
        cycleLength: state.onboardDraft.cycleLength,
        lastPeriodDate: state.onboardDraft.lastPeriod,
        onboardStep: 0,
        screen: 'home',
      };
