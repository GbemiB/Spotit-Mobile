...
function createStyles(c) {
  return StyleSheet.create({
    ...
    heroSP: { fontSize: 32, fontWeight: '800', color: c.white, letterSpacing: -0.5 },
    heroLevel: { fontSize: 16, fontWeight: '700', color: c.white },
    heroMeta: { fontSize: 11, color: 'rgba(255,255,255,0.65)', fontWeight: '600' },
    streakCard: { padding: 18, alignItems: 'center', marginTop: 0 },
    streakNum: { fontSize: 20, fontWeight: '800', color: c.textPrimary, marginBottom: 4 },
    ...
    rewardTitle: { fontSize: 15, fontWeight: '700', color: c.textPrimary, marginBottom: 4 },
    rewardDesc: { fontSize: 12.5, color: c.textMuted, lineHeight: 18 },
    ...
    earnPoints: { fontSize: 13, fontWeight: '700', color: c.primary },
    ...
    badgeLabel: { fontSize: 13, fontWeight: '700', color: c.textPrimary, marginBottom: 4, textAlign: 'center' },
    badgeDesc: { fontSize: 11, color: c.textMuted, textAlign: 'center', lineHeight: 16 },
