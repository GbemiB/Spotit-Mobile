...
function createStyles(c) {
  return StyleSheet.create({
    ...
    name: { fontSize: 28, fontWeight: '800', color: c.textPrimary, letterSpacing: -0.5 },
    ...
    ringEmoji: { fontSize: 34, marginBottom: 4 },
    phaseLabel: { fontSize: 16, fontWeight: '700', marginBottom: 2 },
    cycleDayTx: { fontSize: 13, color: c.textMuted, fontWeight: '600' },
    ...
    loggedTx: { fontSize: 15, fontWeight: '700', color: c.success },
    ...
    spLabel: { fontSize: 11, color: 'rgba(255,255,255,0.7)', fontWeight: '600', marginBottom: 2 },
    spVal: { fontSize: 26, fontWeight: '800', color: c.white },
    spLvl: { fontSize: 16, fontWeight: '700', color: c.white },
    spMeta: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 },
    spMetaTx: { fontSize: 11, color: 'rgba(255,255,255,0.8)', fontWeight: '600' },
    phaseChip: { alignSelf: 'flex-start', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 99, marginBottom: 10 },
    phaseTipTx: { fontSize: 14, color: c.textSecondary, lineHeight: 22 },
    tipCard: { width: 200, padding: 18 },
    tipIcon: { fontSize: 28, marginBottom: 10 },
    tipTitle: { fontSize: 14, fontWeight: '700', color: c.textPrimary, marginBottom: 6 },
    tipBody: { fontSize: 12.5, color: c.textMuted, lineHeight: 19 },
